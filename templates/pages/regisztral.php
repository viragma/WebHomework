<?php
echo "jeeey";
if(isset($_POST['username']) && isset($_POST['password']) && isset($_POST['lastname']) && isset($_POST['firstname']) && isset($_POST['email'])) {
    echo "jeeee";
    try {
        // Kapcsolódás
        ...
        if($row = $sth->fetch(PDO::FETCH_ASSOC)) {
            ...
            $sqlInsert = "insert into users(userid,lastname, firstname, username, password,email)
                          values(0, :lastname, :firstname, :usrename, :password,:email)";
